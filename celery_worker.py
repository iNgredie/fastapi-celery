...
# Example process of lon running task
@celery.task
def create_order(name: str, quantity: int):
    print(name, quantity)
    # 5 second per 1 order
    ...
    # Display log
    celery_log.info('Order Complete!')
    return {
        'message': f'Hi {name}, Your order has completed!',
